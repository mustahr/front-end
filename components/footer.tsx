...
const Footer = () => {
    return (
        <>
            <div className="relative -z-[2] min-w-full min-h-screen"></div>
            <footer className="w-full bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 fixed bottom-0 -z-[1]">
                <div className="bg-slate-200 px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 border-t-2 border-gray-200 pt-6">
                        <div>
                            <Image src="/logo.png" className="mr-5" alt="logo" width={150} height={50} />
